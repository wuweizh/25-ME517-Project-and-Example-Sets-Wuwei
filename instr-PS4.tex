...
At point $B$, a second, rigid rod is joined to the end such that exerting a force on the rod will induce a counterclockwise torque about the axis of $AB$ as shown. 
A point force of magnitude $P_0$ is applied to the rod as shown, causing the front face to turn counterclockwise. 
